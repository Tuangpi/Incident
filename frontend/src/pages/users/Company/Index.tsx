...
const Company = () => {
  ...
  const handleActionToggle = (id: string, e: React.MouseEvent<SVGElement>) => {
    e.stopPropagation();
              ...
              <td className="text-zinc-300 border border-solid border-zinc-600 text-sm">
                <div className="flex justify-center items-center relative">
                  <BiMenuAltLeft
                    ...
                    onClick={(e) => handleActionToggle("4", e)}
                  />
                  {actionId == "4" && (
                    <div
              ...
              <td className="text-zinc-300 border border-solid border-zinc-600 text-sm">
                <div className="flex justify-center items-center relative">
                  <BiMenuAltLeft
                    size={20}
                    className="cursor-pointer"
                    onClick={(e) => handleActionToggle("3", e)}
                  />
                  {actionId == "3" && (
                    <div
                      className="bg-zinc-700 w-28 h-32 absolute top-2 right-14 rounded-md p-2 px-2.5"
              ...
              <td className="text-zinc-300 border border-solid border-zinc-600 text-sm">
                <div className="flex justify-center items-center relative">
                  <BiMenuAltLeft
                    size={20}
                    className="cursor-pointer"
                    onClick={(e) => handleActionToggle("2", e)}
                  />
                  {actionId === "2" && (
                    <div
                      className="bg-zinc-700 w-28 h-32 absolute top-2 right-14 rounded-md p-2 px-2.5"
              ...
              <td className="text-zinc-300 border border-solid border-zinc-600 text-sm">
                <div className="flex justify-center items-center relative">
                  <BiMenuAltLeft
                    size={20}
                    className="cursor-pointer"
                    onClick={(e) => handleActionToggle("1", e)}
                  />
                  {actionId == "1" && (
                    <div
                      className="bg-zinc-700 w-28 h-32 absolute top-2 right-14 rounded-md p-2 px-2.5"
